...
俯视视角下的极简乒乓球回合轨迹视觉项目。当前已经进入 v0.4 移动端竖屏优化版本，在 v0.3 UI 基础上补充触控交互和紧凑布局。
...
- 项目入口：`index.html`
- 当前版本：`pingpong_topdown_0.4/index.html`
- 当前优先优化移动端竖屏布局和触控操作，不改变节拍器回合与状态机逻辑
...
```text
http://<电脑局域网 IPv4>:5500/projects/pingpong_topdown/pingpong_topdown_0.4/
```
...
- 继续微调击球与落台音色，保持第一拍与普通拍之间清晰但不过度突兀的区分
