...
- [Recursive Cells](./projects/recursive_cells/): a dynamic black-and-white recursive cell-splitting experiment where static rest points stabilize the topology while the shared metronome drives point motion and beat pulses. The current main version is v0.1.
